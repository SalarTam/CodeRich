    ...
    public class CookieManager
    {
        ...
        public string getCookieValue(string cookiename)
        {
            if (System.Web.HttpContext.Current.Request.Cookies[cookiename] != null)
                return System.Web.HttpUtility.UrlDecode(System.Web.HttpContext.Current.Request.Cookies[cookiename].Value);
            else
                return string.Empty;
        ...
        public string getSubCookieValue(string cookiename, string subkey)
        {
            if (System.Web.HttpContext.Current.Request.Cookies[cookiename] != null)
            {
                string cookieValue = System.Web.HttpUtility.UrlDecode(System.Web.HttpContext.Current.Request.Cookies[cookiename].Value);
                string subKeyName = subkey + "=";
                if (cookieValue.IndexOf(subKeyName) == -1)
                    return string.Empty;
                else
                    return System.Web.HttpUtility.UrlDecode(System.Web.HttpContext.Current.Request.Cookies[cookiename][subkey]);
            }
            else
                return string.Empty;
        ...
        public NameValueCollection getCookieValues(string cookiename)
        {
            if (System.Web.HttpContext.Current.Request.Cookies[cookiename] != null)
            {
                NameValueCollection values = System.Web.HttpContext.Current.Request.Cookies[cookiename].Values;
                if (values != null)
                {
