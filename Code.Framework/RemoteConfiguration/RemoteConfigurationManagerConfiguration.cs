        ...
        public static RemoteConfigurationManagerConfiguration DefaultConfig
        {
            get
            {
                if (defaultConfig == null)
                {
                    ...
                    {
                        config.RemoteConfigurationUrl = "http://configp.zpidc.com/ConfigVersionHandler.ashx";
                    }
                    else if (ConfigUtility.IsStage)
                    {
                        config.RemoteConfigurationUrl = "http://configl.zpidc.com/ConfigVersionHandler.ashx";
                    }
                    else if (ConfigUtility.IsTesting)
                    {
                        config.RemoteConfigurationUrl = "http://configt.zpidc.com/ConfigVersionHandler.ashx";
                    }
                    else
                    {
                        config.RemoteConfigurationUrl = "http://configd.zpidc.com/ConfigVersionHandler.ashx";
                    }
